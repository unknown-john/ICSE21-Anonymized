...
directory = get_directories(subject_dir)
...
LongParameter = csv.writer(file(save_to_directory+'LongParameterList.csv','wb'))
LongParameter.writerow(['subject','tag','file','lineno','PAR'])
LongMethod = csv.writer(file(save_to_directory+'LongMethod.csv','wb'))
LongMethod.writerow(['subject','tag','file','lineno','MLOC'])
LongScopeChaining = csv.writer(file(save_to_directory+'LongScopeChaining.csv','wb'))
LongScopeChaining.writerow(['subject','tag','file','lineno','DOC'])
LongBaseClass = csv.writer(file(save_to_directory+'LongBaseClassList.csv','wb'))
LongBaseClass.writerow(['subject','tag','file','lineno','NBC'])
LargeClass = csv.writer(file(save_to_directory+'LargeClass.csv','wb'))
LargeClass.writerow(['subject','tag','file','lineno','CLOC'])
ComplexLambda = csv.writer(file(save_to_directory+'ComplexLambdaExpression.csv','wb'))
ComplexLambda.writerow(['subject','tag','file','lineno','NOC','PAR','NOO'])
LongTernary = csv.writer(file(save_to_directory+'LongTernaryConditionalExpression.csv','wb'))
LongTernary.writerow(['subject','tag','file','lineno','NOC','NOL'])
ContainerComprehension = csv.writer(file(save_to_directory+'ComplexContainerComprehension.csv','wb'))
ContainerComprehension.writerow(['subject','tag','file','lineno','NOC','NOFF','NOO'])
LongMessageChain = csv.writer(file(save_to_directory+'LongMessageChain.csv','wb'))
LongMessageChain.writerow(['subject','tag','file','lineno','LMC'])
MultiplyNestedContainer = csv.writer(file(save_to_directory+'MultiplyNestedContainer.csv','wb'))
...
for name in directory.keys():
    ...
    for currentFileName in util.walkDirectory(sourcedir):
      try:
        ...
        print "error:",name,tag,currentFileName
        continue
