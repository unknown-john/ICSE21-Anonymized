...
use traditional_queries;

const PROJECT_NAME: &'static str = "traditional_queries";
...
pub fn main() {
    ...
    execute_query!(database, traditional_queries::starred_query);
    execute_query!(database, traditional_queries::custom_query);
