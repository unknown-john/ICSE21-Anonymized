...
# Collects the precision of style-analyzer's work on a repo from the report it generates. 
# It just produces a line for a CSV file containing the name of the repo (if provided) and the name of the repo. 
...
# We want to extract the Precision column (so 3rd) from the micro avg row.
